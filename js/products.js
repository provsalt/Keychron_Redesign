...
class ProductsPage {
    ...
    async fetchProducts() {
        ...
        `;
                productsGrid.querySelector('.retry-button')?.addEventListener('click', () => this.init());
            }
        }
    }
    ...
    getFilteredProducts() {
        return this.products
            .filter(product => {
                const layoutMatch = this.filters.layout === 'all' ||
    ...
    render() {
      ...
      `).join('') :
        ...
        document.getElementById("showing-count").innerHTML = filteredProducts.length;
        document.getElementById("total-count").innerHTML = this.products.length.toString();

        productsGrid.querySelector('.reset-filters-button')?.addEventListener('click', () => {
            this.resetFilters();
        });
    ...
    removeFilter(type, value) {
        switch (type) {
            ...
            case 'feature':
                ...
                const featureCheckbox = document.querySelector(`[data-filter="features"][value="${value}"]`);
    ...
    resetFilters() {
        ...
        document.querySelectorAll('[data-filter="features"]').forEach(checkbox => {
